...
void Ventana::initGLEW() {
  ...
  glFrontFace(GL_CCW);     // Las caras frontales son las que tienen vértices en
                           // sentido antihorario
}
...
void Ventana::initViewProyection() {
  ...
  view = glm::lookAt(glm::vec3(0.0f, 0.0f, -10.0f), glm::vec3(0.0f),
...
void Ventana::idel() {}
void Ventana::finish() { model->finish(); }
